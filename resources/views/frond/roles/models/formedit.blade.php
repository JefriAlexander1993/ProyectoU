<div class="modal fade" id="myformrolesedit" role="dialog" style="padding: 100px 0px 70px 0px;">
    <div class="modal-dialog">
	      ...
	      <div class="modal-content" style="width:400px;height:400px;margin-left:100px">
	        <div class="modal-header" style="background:#26B99A;">
	          ...
	          <h2 class="modal-title" align="center" style="color:#fff"><STRONG>EDITAR ROLES.</STRONG></h2>
	        </div>
				        ...
				        <div class="row">
				       		<div class="col-sm-12"> 
				       		    <div class="form-group">	
							        <input type="text" required class="form-control"  placeholder="Ej: admin, cliente, empleado" name="name" title="Nombre del rol">	
