 <div class="modal fade" id="myformpermissions" role="dialog" style="padding: 100px 0px 70px 0px;">
    <div class="modal-dialog">
	      ...
	      <div class="modal-content" style="width:400px;height:400px;margin-left:100px">
	        <div class="modal-header" style="background:#26B99A;">
	          ...
	          <h2 class="modal-title" align="center" style="color:#fff"><STRONG>CREAR PERMISOS.</STRONG></h2>
	        </div>
