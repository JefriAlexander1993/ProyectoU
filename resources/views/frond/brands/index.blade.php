...
@section('content')
  ...
  <div class="col-sm-4" style="padding-right:1px">
          <div class="card-body" >
              ...
              <!-- Tab panes -->
              <div class="tab-content" style="padding-left:90px">
                <div role="tabpanel" class="tab-pane fade in active" id="table" >
                      <div id="editusers" class="card">
                        <div  class="card-header card-header-info">
                          <h4 class="card-title "><strong>Editar marca</strong></h4>

                        </div>
                        <div class="card-body">
                          <div class="col-sm-12">
                            @include('frond.brands.fragment.formedit')
                        </div>
                      </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="variables">
                  <div  class="card">
                    <div  class="card-header card-header-success">
                      <h4 class="card-title "><strong>Crear marca</strong></h4>

                    </div>
                      <div class="card-body">
                        <div class="col-sm-12">
                              @include('frond.brands.fragment.form')
                      </div>
                    </div>
                  </div>
            </div>
            <div role="tabpanel" class="tab-pane fade in active" id="ver" >
                  <div  class="card">
                    ...
                    <div class="card-body" id="showrol" value="">
                        @include('frond.brands.fragment.show')
                    </div>
            </div>
          </div>
        </div>
...
<!--Lista de producto(Tabla).-->
            ...
            <div class="col-sm-8">
              <div class="card">
                <div  class="card-header card-header-success">
                  <h4 class="card-title "><strong>LISTA DE MARCAS</strong></a></h4>

                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table  id="brands" name="users"  class="table  table-hover">
